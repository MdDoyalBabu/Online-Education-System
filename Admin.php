...
if(isset($_COOKIE['tutor_id'])){
   ...
   // for redirect you are not admin
    $verify_user = $conn->prepare("SELECT * FROM `tutors` WHERE id = ? and action = 0 ");
   $verify_user->execute([$tutor_id]);
  ...
  if($verify_user->rowCount() > 0){
        ...
        echo '<script type="text/javascript">
           window.location = "http://localhost/project/admin/playlists.php"
      </script>';
        header("playlists.php");
...
<section class="playlists">
   ...
   <h1 class="heading">Playlists Control</h1>
...
-->
      ...
      <div class="box">
         ...
         <a href="admin_view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">view playlist</a>
      </div>
      <?php
         } 
      }else{
